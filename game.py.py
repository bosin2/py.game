...
def hidden_ending():
    clear()
    print_slow(
        "준영이 : 입학한게 엊그제 같은데 벌써 졸업이구나 \n" +
    "\n" +
    " 그리고 내 눈 앞에는 바로 n3사 의 사원증...\n" +
    "\n" +
    " 준영이 : 아무리 생각해도 꿈만 같다 내가 여길 입사하다니.\n" +
    "\n" +
    " 수뭉이가 없었다면 불가능 했겠지...\n" + 
    "\n" +
    " 수뭉이가 시간을 되돌려 준 후 정말 열심히 살았다\n" +
    "\n" +
    " 꼬박꼬박 등록금을 내고... 스트레스를 낮추고,,,\n" + 
    "\n" +
    " 정말 열심히 했어 응, 이건 내 노력의 결과다\n" +
    "\n" +
    " 준영이 : 수뭉아 고마워 !!\n" +
    "\n" +
    " 수뭉이가 듣고있을지 아닐지는 모르겠지만 나는 크게 하늘을 향해 소리질렀다\n" +
    "\n" +
    " 상명대와 함께 했던 날들이 스쳐지나 간다 \n" +
    "\n" +
    " 준영이 : 사랑해요 상명대! \n\n")
...
def true_ending():
    ...
    print_slow(
        "준영이 : 입학한게 엊그제 같은데 벌써 졸업이구나 \n" +
    "\n" +
    " 그리고 내 눈 앞에는 바로 교수님의 연구실...\n" +
    "\n" +
    " 준영이 : 아무리 생각해도 꿈만 같다 교수님이 날 불러주시다니\n" +
    "\n" +
    " 수뭉이가 없었다면 불가능 했겠지...\n" + 
    "\n" +
    " 수뭉이가 시간을 되돌려 준 후 정말 열심히 살았다\n" +
...
def bad_ending():
    ...
    " 준영이 : ... 수뭉아 미안하다\n" +
    "\n" +
    " 나는 수뭉이가 시간을 되돌려 준 후 나름 열심히 살았다고 생각했는데\n" +
    "\n" +
    " 아니었나 보다... 나는 5학년을 시작한다...\n" + 
    "\n" +
    " 군대는 언제 가지...\n" +
    "\n" +
    " 아 또 수뭉이가 시간을 되돌려 주지 않을까...\n" + 
    "\n" +
    " 그렇게 생각하며 나는 공학관 옥상에서 담배를 피면서 하늘을 바라봤다...\n" +
    "\n" +
    " 준영이 : 수뭉아... 한 번만 더 도와줘...\n" +
    "\n" +
    " \033[36m *수뭉이요정* :힘들어하는 준영이의 목소리를 듣고 요정 등장 !\033[0m\n" +
    "\n" +
    " 준영이 : 아니 수뭉아 !!!!!!!!!!!!!! 진짜 도와주러 온거야 ???????????? \n" +
    "\n" +
    " 준영이 : 사랑해요 상명대!!!! 끼얏 호우 !\n"+
    "\n" +
    "\033[36m *수뭉이요정* : ... 도와주러 온 건 아니고 정신차리고 살라고 와 봤어 !\033[0m" +
    " 준영이 : 네?? ...\n"+
    "\n" +
    " 아, 난 진짜 죽어야겠다...\n"+
    "\n" +
    " 오늘 따라 공학관 옥상 풍경이 더 잘 보이는 듯 하다... \n"+
    "\n" +
    " 안녕 상명대... 아니 1년 더 다녀야 하는구나... 씁쓸하다...\n" +
    "\n\n") 
